...
<asp:Content ID="HeadCss" ContentPlaceHolderID="HeadContent" runat="server">
    <style>
        ...
        .hero{
            ...
            padding:22px 20px;box-shadow:var(--shadow);margin-bottom:18px
        }
        ...
        .card{
            ...
            box-shadow:var(--shadow);transition:transform .1s,box-shadow .2s,border-color .2s;color:var(--ink)
        }
        ...
        .badge--blue{background:linear-gradient(135deg,#2563eb 0%,#06b6d4 100%);box-shadow:0 8px 20px rgba(37,99,235,.32)}
    ...
    <div class="grid">
        ...
        <div class="card">
            <div class="card-head">
                ...
                <h3 class="card-title"><asp:Literal ID="litListTitle" runat="server" /></h3>
            </div>
            <p class="card-text"><asp:Literal ID="litListText" runat="server" /></p>
            <div class="chips">
                <span class="chip"><asp:Literal ID="litListChip1" runat="server" /></span>
                <span class="chip"><asp:Literal ID="litListChip2" runat="server" /></span>
            </div>
            <div class="cta">
                <span><asp:Literal ID="litListCta" runat="server" /></span>
        ...
        <asp:HyperLink ID="lnkArtistas" runat="server" NavigateUrl="~/CargarArtistas.aspx" CssClass="card-link">
            <div class="card">
                <div class="card-head">
                    ...
                    <h3 class="card-title"><asp:Literal ID="litArtTitle" runat="server" /></h3>
                </div>
                <p class="card-text"><asp:Literal ID="litArtText" runat="server" /></p>
                <div class="chips">
                    <span class="chip"><asp:Literal ID="litArtChip1" runat="server" /></span>
                    <span class="chip"><asp:Literal ID="litArtChip2" runat="server" /></span>
                </div>
                <div class="cta">
                    <span><asp:Literal ID="litArtCta" runat="server" /></span>
                    <svg viewBox="0 0 24 24" fill="none"><path d="M9 5l7 7-7 7" stroke="currentColor" stroke-width="1.6" stroke-linecap="round" stroke-linejoin="round"/></svg>
                </div>
            </div>
        </asp:HyperLink>
        ...
        <asp:HyperLink ID="lnkObras" runat="server" NavigateUrl="~/CargarObras.aspx" CssClass="card-link">
            <div class="card">
                <div class="card-head">
                    ...
                    <h3 class="card-title"><asp:Literal ID="litObrTitle" runat="server" /></h3>
                </div>
                <p class="card-text"><asp:Literal ID="litObrText" runat="server" /></p>
                <div class="chips">
                    <span class="chip"><asp:Literal ID="litObrChip1" runat="server" /></span>
                    <span class="chip"><asp:Literal ID="litObrChip2" runat="server" /></span>
                </div>
                <div class="cta">
                    <span><asp:Literal ID="litObrCta" runat="server" /></span>
                    <svg viewBox="0 0 24 24" fill="none"><path d="M9 5l7 7-7 7" stroke="currentColor" stroke-width="1.6" stroke-linecap="round" stroke-linejoin="round"/></svg>
                </div>
            </div>
        </asp:HyperLink>
        ...
        <asp:HyperLink ID="lnkStats" runat="server" NavigateUrl="~/EstadisticasCurador.aspx" CssClass="card-link">
            <div class="card">
                <div class="card-head">
                    ...
                    <h3 class="card-title"><asp:Literal ID="litStaTitle" runat="server" /></h3>
                </div>
                <p class="card-text"><asp:Literal ID="litStaText" runat="server" /></p>
                <div class="chips">
                    <span class="chip"><asp:Literal ID="litStaChip1" runat="server" /></span>
                    <span class="chip"><asp:Literal ID="litStaChip2" runat="server" /></span>
                </div>
                <div class="cta">
                    <span><asp:Literal ID="litStaCta" runat="server" /></span>
                    <svg viewBox="0 0 24 24" fill="none"><path d="M9 5l7 7-7 7" stroke="currentColor" stroke-width="1.6" stroke-linecap="round" stroke-linejoin="round"/></svg>
                </div>
            </div>
        </asp:HyperLink>
