...
<asp:Content ID="Main" ContentPlaceHolderID="MainContent" runat="server">
    <div class="wrap">
                ...
                <ItemTemplate>
                    <div class="card">
                        ...
                        <asp:Panel ID="pOk" runat="server" Visible="false">
                            <span class="chip">
                                <asp:Label ID="lblOkChip" runat="server" /></span>
                        </asp:Panel>
                        ...
                        <asp:Panel ID="pCorrupt" runat="server" Visible="false">
                            ...
                            <asp:Repeater ID="rptIds" runat="server">
                                <ItemTemplate>
                                    <span class="chip">
                                        <asp:Literal ID="litChip" runat="server" /></span>
                                </ItemTemplate>
                            </asp:Repeater>
                        </asp:Panel>
                    </div>
        ...
        <div class="footer-actions">
            ...
            <asp:HyperLink ID="lnkRestore" runat="server" NavigateUrl="RestoreDB.aspx" CssClass="btn btn-primary" Text="Restaurar base" />
        </div>
    </div>
</asp:Content>
