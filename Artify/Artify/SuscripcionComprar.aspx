<%@ Page Title="Suscripción" Language="C#" MasterPageFile="~/Site.Master"
    AutoEventWireup="true" CodeBehind="SuscripcionComprar.aspx.cs" Inherits="Artify.SuscripcionComprar" %>
...
<asp:Content ID="Body" ContentPlaceHolderID="MainContent" runat="server">
  <div class="hero">
    ...
    <div class="card">
      <div>
        <div class="row">
          <div><strong><asp:Literal ID="litPlanName" runat="server" /></strong></div>
