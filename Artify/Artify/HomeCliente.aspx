...
<asp:Content ID="Body" ContentPlaceHolderID="MainContent" runat="server">
  ...
  <asp:PlaceHolder ID="phEmpty" runat="server" Visible="false">
    <div class="empty"><asp:Literal ID="litEmpty" runat="server" /></div>
  </asp:PlaceHolder>
    ...
    <ItemTemplate>
      <div class="card">
        ...
        <div class="body">
          ...
          <div class="state">
            <span class="badge"><asp:Literal ID="litEstado" runat="server" /></span>
            <span><asp:Literal ID="litTiempo" runat="server" /></span>
          </div>
