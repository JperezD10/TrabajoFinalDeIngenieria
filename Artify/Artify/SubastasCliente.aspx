<%@ Page Title="Inicio" Language="C#" MasterPageFile="~/Site.Master"
    AutoEventWireup="true" CodeBehind="SubastasCliente.aspx.cs" Inherits="Artify.SubastaCliente" %>
...
<asp:Content ID="Body" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <a href="HomeCliente.aspx" class="back-link">
        <asp:Literal ID="litBackHome" runat="server" Text="subcli.backHome" />
    </a>
            ...
            <div class='card <%# (bool)Eval("EsOriginal") ? "original" : "" %>'>
                ...
                <div class="body">
                    ...
                    <div class="state">
                        ...
                        <span>
                            <asp:Literal ID="litTiempo" runat="server" />
                        </span>
                    </div>
