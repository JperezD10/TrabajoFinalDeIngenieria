...
<asp:Content ID="HeadCss" ContentPlaceHolderID="HeadContent" runat="server">
  ...
  .card h2{margin:0 0 10px 0;color:#f3f4f6;font-size:1.25rem;font-weight:800}
  .meta{display:grid;grid-template-columns:1fr 1fr;gap:10px;margin-top:10px}
  .meta div{background:#0b1220;border:1px solid #334155;border-radius:12px;padding:12px}
  .meta .k{display:block;font-size:.8rem;color:#9ca3af;margin-bottom:4px}
  .meta .v{color:#e5e7eb;font-weight:700}
  .hero-img{width:100%;aspect-ratio:4/3;object-fit:cover;border-radius:14px;border:1px solid #334155}
  .price-row{display:flex;align-items:center;justify-content:space-between;gap:10px;margin:10px 0 6px}
  .price{font-size:1.6rem;font-weight:900;color:#e5e7eb}
...
<asp:Content ID="Main" ContentPlaceHolderID="MainContent" runat="server">
  ...
  <div class="auction-wrap">
    <div class="card">
      <h2><asp:Literal ID="litInfoSection" runat="server" /></h2>
      <asp:Image ID="imgObra" runat="server" CssClass="hero-img" ImageUrl="~/img/placeholder.png" />
      <div class="meta">
        <div><span class="k"><asp:Literal ID="litLblTitulo" runat="server" /></span><span class="v"><asp:Literal ID="litTitulo" runat="server" /></span></div>
        <div><span class="k"><asp:Literal ID="litLblArtista" runat="server" /></span><span class="v"><asp:Literal ID="litArtista" runat="server" /></span></div>
        <div><span class="k"><asp:Literal ID="litLblAnio" runat="server" /></span><span class="v"><asp:Literal ID="litAnio" runat="server" /></span></div>
        <div><span class="k"><asp:Literal ID="litLblTecnica" runat="server" /></span><span class="v"><asp:Literal ID="litTecnica" runat="server" /></span></div>
        <div><span class="k"><asp:Literal ID="litLblPrecioBase" runat="server" /></span><span class="v"><asp:Literal ID="litPrecioBase" runat="server" /></span></div>
        <div><span class="k"><asp:Literal ID="litLblOfertas" runat="server" /></span><span class="v"><asp:Literal ID="litOfertasCount" runat="server" /></span></div>
        <div><span class="k"><asp:Literal ID="litLblCierra" runat="server" /></span><span class="v"><asp:Literal ID="litCierraFecha" runat="server" /></span></div>
        <div><span class="k"><asp:Literal ID="litLblEstado" runat="server" /></span><span class="v"><span class="badge"><asp:Literal ID="litEstado" runat="server" /></span></span></div>
      </div>
    </div>

    <div class="card">
      <h2><asp:Literal ID="litBidSection" runat="server" /></h2>

      <div class="price-row">
        <div>
          <div class="muted"><asp:Literal ID="litLblPrecioActual" runat="server" /></div>
          <div class="price"><asp:Literal ID="litPrecioActual" runat="server" /></div>
        </div>
        <div>
          <div class="muted"><asp:Literal ID="litLblTiempoRestante" runat="server" /></div>
      ...
      <asp:Panel ID="pnlPuja" runat="server">
        <label class="muted" for="txtMonto"><asp:Literal ID="litLblTuOferta" runat="server" /></label>
