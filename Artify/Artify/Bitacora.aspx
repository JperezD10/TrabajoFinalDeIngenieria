<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Bitacora.aspx.cs" Inherits="Artify.Bitacora" %>
...
<head runat="server">
    ...
    <style>
        :root {
            ...
            --panel: #1f2937; /* panel/tabla */
            --border: #374151;
            --shadow: 0 6px 18px rgba(0,0,0,.4);
            --ink: #f3f4f6; /* texto */
            --muted: #9ca3af;
            --accent: #6366f1; /* para hover / detalles */
        }
        ...
        * {
        ...
        .gridview {
            ...
            .gridview th {
                background: #6d28d9; /* violeta elegante */
                color: #f9fafb;
                padding: 12px;
                text-align: left;
                font-weight: 600;
