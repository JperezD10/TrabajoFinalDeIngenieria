...
<body>
    <form id="form1" runat="server">
        ...
        <div class="login">
            <div class="lang">
                <asp:Label ID="lblLang" runat="server" CssClass="label" AssociatedControlID="ddlLang"></asp:Label>
            ...
            <div class="field">
                <asp:Label ID="lblPass" runat="server" CssClass="label" AssociatedControlID="txtPassword"></asp:Label>
                <div class="pwd-wrap">
                    <asp:TextBox ID="txtPassword" runat="server" TextMode="Password" CssClass="input" />
                    <button runat="server" id="btnTogglePwd" type="button" class="toggle-eye" onclick="togglePwd()"
                        aria-label="">
                        <svg id="eyeIcon" viewBox="0 0 24 24" fill="none" aria-hidden="true">
                            <path d="M2 12s4-7 10-7 10 7 10 7-4 7-10 7S2 12 2 12Z" stroke="currentColor" stroke-width="1.8"></path>
